...
describe LogStash::Outputs::Logan do
  describe '#register' do
    context 'when receiving invalid configuration' do
      ...
      let(:invalid_config3) do
        { 'namespace' => 'example', 'dump_zip_file' => true, 'zip_file_location' => '/not/a/real/dir' }
      end
      ...
      it 'fails when auth_type is invalid', :unit_test do
        ...
        expect do
          plugin_fail.register
        end.to raise_error(LogStash::ConfigurationError, /Invalid authType/)
      end
      ...
      it 'fails before client initialization when ConfigFile is missing a config path', :unit_test do
        ...
        expect do
          plugin_fail.register
        end.to raise_error(LogStash::ConfigurationError, /invalid config_file_location/)
      end
    end
  end
