...
# rubocop:disable Metrics/BlockLength, Naming/VariableName
describe LogStash::Outputs::LogAnalytics::Uploader do
  ...
  subject do
    described_class.new(namespace, dump_zip_file, client_provider, collection_source,
                        zip_file_location, plugin_retry_on_4xx, plugin_retry_on_5xx,
                        retry_wait_on_4xx, retry_max_times_on_4xx,
  ...
  context 'testing function return formats' do
    describe '#get_logSets_map_per_logGroupId' do
      it 'returns only log sets Hash', :unit_test do
        ...
        logSets_per_logGroupId_map, oci_la_global_metadata = subject.get_logSets_map_per_logGroupId(
      ...
      it 'returns metadata Hash', :unit_test do
        ...
        _, oci_la_global_metadata = subject.get_logSets_map_per_logGroupId(oci_la_log_group_id,
                                                                           records_per_logGroupId)
    ...
    describe '#get_zipped_stream' do
      it 'returns zippedstream for payload', :unit_test do
        ...
        zippedstream, number_of_records = subject.get_zipped_stream(oci_la_log_group_id, oci_la_global_metadata,
      ...
      it 'returns zip stream with 2 or more events', :unit_test do
        ...
        records_per_logSet_map = logSets_per_logGroupId_map[1]
        _, number_of_records = subject.get_zipped_stream(oci_la_log_group_id, oci_la_global_metadata,
                                                         records_per_logSet_map)
      ...
      it 'saves to local', :unit_test do
        Dir.mktmpdir do |directory|
          uploader = described_class.new(namespace, dump_zip_file, client_provider, collection_source,
                                         directory, plugin_retry_on_4xx, plugin_retry_on_5xx,
                                         retry_wait_on_4xx, retry_max_times_on_4xx,
                                         retry_wait_on_5xx, retry_max_times_on_5xx, logger)
          ...
          logSets_per_logGroupId_map, oci_la_global_metadata = uploader.get_logSets_map_per_logGroupId(
            oci_la_log_group_id, records_per_logGroupId
          )
          records_per_logSet_map = logSets_per_logGroupId_map[1]
          zippedstream, = uploader.get_zipped_stream(oci_la_log_group_id, oci_la_global_metadata,
                                                     records_per_logSet_map)
    ...
    context 'when zip_file_location is not provided' do
      it 'does not save zip file locally', :unit_test do
        no_file_location_uploader = described_class.new(namespace, dump_zip_file, client_provider, collection_source,
                                                        nil, plugin_retry_on_4xx, plugin_retry_on_5xx,
                                                        retry_wait_on_4xx, retry_max_times_on_4xx,
                                                        retry_wait_on_5xx, retry_max_times_on_5xx, logger)
        ...
        logSets_per_logGroupId_map, oci_la_global_metadata = no_file_location_uploader.get_logSets_map_per_logGroupId(
          oci_la_log_group_id, records_per_logGroupId
        )
        records_per_logSet_map = logSets_per_logGroupId_map[1]
        zippedstream, = no_file_location_uploader.get_zipped_stream(oci_la_log_group_id,
                                                                    oci_la_global_metadata, records_per_logSet_map)
...
# rubocop:enable Metrics/BlockLength, Naming/VariableName
